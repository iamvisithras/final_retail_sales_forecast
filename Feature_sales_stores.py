...
if submit_button and flag==0:
    ...
    import pickle 
    with open(r"C:\guvi\project\guvi project\final_retail_sales_forecast\model.pkl", 'rb') as file:
        loaded_model = pickle.load(file)
    with open(r'C:\guvi\project\guvi project\final_retail_sales_forecast\scaler.pkl', 'rb') as f:
